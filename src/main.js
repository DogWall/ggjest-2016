(function () {
    ...
    require(['phaser', 'scenes/game', 'scenes/boot', 'scenes/preloader', 'scenes/menu', 'scenes/credit', 'scenes/runes', 'scenes/lobby', 'scenes/profile', 'scenes/waiting', 'scenes/tempo', 'scenes/score'], function (Phaser, Game, Boot, Preloader, Menu, Credit, Runes, Lobby, Profile, Waiting, Tempo, Score) {
